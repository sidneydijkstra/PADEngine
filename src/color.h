...
struct Color {
	...
	static Color lerpColor(Color _c1, Color _c2, float _amount) {
		...
		uint8_t rn = (uint8_t)floor(_c1.r + (_c2.r - _c1.r) * _amount);
		uint8_t gn = (uint8_t)floor(_c1.g + (_c2.g - _c1.g) * _amount);
		uint8_t bn = (uint8_t)floor(_c1.b + (_c2.b - _c1.b) * _amount);
		uint8_t an = (uint8_t)floor(_c1.a + (_c2.a - _c1.a) * _amount);
