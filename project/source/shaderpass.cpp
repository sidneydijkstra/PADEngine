...
void ShaderPass::setup() {
	...
	const VkDescriptorSetLayout layout = _descriptor->getLayout();

	VkPipelineShaderStageCreateInfo shaderStages[2] = { stages[0]->getStateInfo(), stages[1]->getStateInfo() };
	...
	rasterizer.cullMode = VK_CULL_MODE_NONE; // VK_CULL_MODE_BACK_BIT; TODO: watch
	...
	pipelineLayoutInfo.pSetLayouts = &layout; // TODO: set
