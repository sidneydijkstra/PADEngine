...
void RenderPass::setup() {
	...
	colorAttachment.samples = DeviceHandler::getInstance()->getMsaaSamples();
	...
	depthAttachment.samples = DeviceHandler::getInstance()->getMsaaSamples();
	...
	colorAttachmentResolve.format = SwapChainHandler::getInstance()->getSwapChainImageFormat();
	...
	VkSubpassDescription subpass{}; // new added
